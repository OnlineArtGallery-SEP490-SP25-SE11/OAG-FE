...
import { BUILDING_ROOM_CONFIG } from '@/utils/gallery-config';
...
import BuildingRoomModel from './modern-a1-gallery-model';

export default function ModernA1Gallery() {
    const { X_AXIS, Y_AXIS, Z_AXIS } = BUILDING_ROOM_CONFIG.DIMENSION;
    ...
    const exhibitionFeatures = useMemo(
        () => [
            <BuildingRoomModel key="building-room-model" />
        ],
