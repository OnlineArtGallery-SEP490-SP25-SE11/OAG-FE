    ...
    return (
        ...
        >
            <Card className={`overflow-hidden rounded-lg border ${
                moderationStatus === 'pending' ? 'border-amber-300' : 
                    ...
                    <div className="flex gap-1 p-1 bg-teal-50/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-sm relative">
                        ...
                        {MODERATION_STATUS_OPTIONS.map((option) => (
                            <motion.button
                                ...
                                whileHover={{ y: -2 }}
                                whileTap={{ scale: 0.95 }}
                                className={`flex items-center justify-center gap-1.5 py-2 px-3 text-sm rounded-md transition-all duration-200 flex-1 min-w-[90px] z-10 ${
