        ...
        <div className='bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-6 hover:border-purple-200 transition duration-200'>
         ...
         <div className='space-y-4'>
          ...
          <div className='flex flex-wrap items-center gap-3'>
           <select
            className='flex-1 text-sm rounded-lg border border-gray-200 bg-white px-4 py-2.5 shadow-sm focus:border-purple-500 focus:ring-purple-500 hover:border-purple-200 transition duration-200'
            value={newGenre}
