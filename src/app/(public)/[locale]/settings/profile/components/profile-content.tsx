          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="text-center max-w-2xl">
              ...
              <p className="text-xs text-gray-500 mt-4">
                {t("common.joined", {
                  date: new Date(initialData.createdAt).toLocaleDateString(
                    "en-US",
                    {
                      month: "long",
                      year: "numeric",
      ...
      <Tabs defaultValue="collections" className="w-full">
        <TabsList className="flex justify-center space-x-2 border-b border-gray-200 pb-2">
          ...
          >
            ...
            <span>{t("view.following")}</span>
          </TabsTrigger>
        </TabsList>

        <TabsContent value="favorites" className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {["Thuy Nguyen", "Mai Lan", "Van Cao"].map((artist, index) => (
              <motion.div
                key={index}
