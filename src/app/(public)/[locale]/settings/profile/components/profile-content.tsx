      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-4 lg:col-span-3 space-y-6">
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              />
              <h1 className="text-2xl font-bold text-center">{initialData.name}</h1>
            ...
            <div className="space-y-2 pt-2">
              {!initialData.role?.includes("artist") && (
                <Button onClick={() => router.push("/settings")} variant="outline" className="w-full justify-start" size="sm">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
                  ...
                  <div className="md:col-span-2 space-y-6">
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                      ...
                      <div className="prose max-w-none">
                        {initialData.role?.includes("artist") && initialData.artistProfile?.bio ? (
                          <div className="text-gray-700" dangerouslySetInnerHTML={{ __html: initialData.artistProfile.bio }} />
                        ) : (
                    ...
                    {initialData.role?.includes("artist") && initialData.artistProfile?.genre && initialData.artistProfile.genre.length > 0 && (
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <h3 className="text-xl font-semibold mb-4 text-gray-800 flex items-center border-b pb-2">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-medium text-gray-900">{t("edit.address")}</p>
                            <p className="text-sm text-gray-500">{initialData.address || t("view.no_address")}</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <div className="flex-shrink-0 h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center">
            ...
            {activeTab === "followers" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold border-b pb-2">{t("common.followers")}</h2>
            ...
            {activeTab === "following" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold border-b pb-2">{t("common.following")}</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {following.length > 0 ? (
                    following.map((user) => (
                      <motion.div
