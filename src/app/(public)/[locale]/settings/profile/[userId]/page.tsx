										...
										<ReportButton
											...
											triggerElement={
												<Button
													variant='outline'
													size='sm'
													className='flex items-center gap-1.5 text-gray-700 w-full justify-center'
												>
											...
											(follower: {
												...
												>
													...
													<Button
														...
														variant='outline'
														onClick={() =>
															(window.location.href = `/settings/profile/${follower._id}`)
														}
													>
														Xem hồ sơ
													</Button>
											...
											(following: {
												...
												>
													...
													<Button
														...
														variant='outline'
														onClick={() =>
															(window.location.href = `/settings/profile/${following._id}`)
														}
													>
														Xem hồ sơ
													</Button>
									...
									{user?.artistProfile ? (
										<div className='space-y-6'>
											...
											<div className='mt-8'>
												...
												{/* Nút xem thêm */}
												{user.artworksCount &&
													user.artworksCount > 6 && (
														<div className='text-center mt-4'>
															<Button
																variant='outline'
																className='mt-4'
																onClick={() =>
																	(window.location.href = `/artworks?artist=${userId}`)
																}
															>
																Xem tất cả{' '}
																{
