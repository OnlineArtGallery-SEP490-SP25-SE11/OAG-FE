		...
		<div className='min-h-screen flex flex-col font-[family-name:var(--font-geist-sans)]'>
			<main className='flex-1 w-full mt-5'>
				<div className='relative w-full min-h-[90vh] flex items-center'>
					...
					>
						<source
							src='https://res.cloudinary.com/djvlldzih/video/upload/v1738983008/gallery/hero_video.mp4'
							type='video/mp4'
						/>
					</video>
					...
					<div className='relative z-10 w-full max-w-4xl mx-auto px-4 text-white'>
						...
						<div className='grid md:grid-cols-2 gap-8 mt-8'>
							...
							<div className='space-y-3'>
								...
								<p className='text-lg'>
									Exhibit your art in beautiful 3D art
									galleries. Share freely, get instant
									visitors and sell your art.
								</p>
							</div>
							...
							<div className='space-y-3'>
								<h2 className='text-2xl font-semibold'>
									Art Lovers & Art Collectors
								</h2>
								<p className='text-lg'>
									Visit 3D art exhibitions from the comfort of
									your browser. Acquire art directly from the
									artist.
								</p>
							</div>
						</div>
