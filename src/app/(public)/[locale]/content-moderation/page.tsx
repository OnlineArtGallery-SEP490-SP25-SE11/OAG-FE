...
const reportReasons = [
  { value: "spam", label: "Spam", description: "Unsolicited or repeated content" },
  { value: "harassment", label: "Harassment", description: "Abusive or threatening behavior" },
  { value: "inappropriate", label: "Inappropriate Content", description: "Content that violates guidelines" },
  { value: "fake", label: "Fake Account", description: "Impersonation or false identity" },
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center space-x-2">
                  <h2 className="text-xl font-semibold">Dang Hai</h2>
