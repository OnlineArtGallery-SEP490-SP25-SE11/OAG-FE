  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      <div className="bg-white rounded-lg border p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Artworks</h2>
        <p className="text-gray-600 leading-relaxed">
          Upload your artwork to their places. You can see your gallery&apos;s floor plan below and the places 
          for art are numbered accordingly. You can check instructions and recommendations on our FAQ page.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">
          You can see your gallery&apos;s floor plan below and the places for art are numbered accordingly. 
          You can check instructions and recommendations on our FAQ page.
        </p>
        ...
        <div className="mt-8">
          ...
          >
            <div className="flex items-center gap-2">
              <span className="font-semibold">Upload Artworks</span>
              <span className="text-sm text-gray-500">0/68 artworks</span>
            </div>
            {isUploadSectionOpen ? (
          ...
          <div className={`transition-all duration-300 ease-in-out ${
            isUploadSectionOpen ? 'opacity-100 max-h-[5000px]' : 'opacity-0 max-h-0'
          } overflow-hidden`}>
