		...
		<div className='max-w-4xl mx-auto p-6 space-y-8'>
			...
			<div className='prose max-w-none mb-8'>
				<p className='text-gray-600'>
					Publish your exhibition, create a unique link name, and
					select if your exhibition is visible on the Virtual Art
			...
			<div className='space-y-4 bg-white rounded-lg border p-6'>
				...
				<div className='space-y-2'>
					...
					<p className='text-sm text-gray-500'>
						Choose a unique name for your exhibition URL. Use only
					...
					<AlertDescription>
						{isPublished ? (
							<div className='mt-2 space-y-2'>
								...
								<p>
									Your exhibition is live and can be visited
									at:
								</p>
								<a
							...
							<p className='mt-2'>
								Your exhibition is not yet published. Click the
								publish button below when you&apos;re ready.
							</p>
						)}
					</AlertDescription>
				</Alert>
