  ...
  const galleryTemplates: GalleryTemplate[] = [
    {
      ...
      description: "A sleek, contemporary space with clean lines and optimal lighting for modern artworks.",
    ...
    },
    {
      ...
      image: "/gallery-preview.jpg",
      description: "Traditional museum layout with elegant architecture and spacious halls.",
    ...
    },
    {
      ...
      image: "/gallery-preview.jpg",
      description: "Simple and focused design that puts your artwork at the center of attention.",
    ...
    },
    {
      ...
      image: "/gallery-preview.jpg",
      description: "Raw and urban atmosphere perfect for contemporary and experimental art.",
    ...
    },
    {
      ...
      image: "/gallery-preview.jpg",
      description: "Immersive digital space that breaks the boundaries of traditional exhibitions.",
    ...
    },
    {
      ...
      image: "/gallery-preview.jpg",
      description: "Open-air gallery space integrating nature with art installations.",
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-2xl">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Choose a Gallery Template</h2>
          </div>
                ...
                <div className="relative w-24 h-24 flex-shrink-0">
                  <Image
                    ...
                    className={`object-cover rounded-full transition-transform duration-200
                      ${selectedTemplate === template.id ? 'scale-105' : 'group-hover:scale-105'}`}
                  />
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {exhibitions.map((exhibition) => (
          <Card 
            ...
            onClick={() => router.push(`/creator/${exhibition.id}/artworks`)}
          >
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <p>Last edited: {new Date(exhibition.lastEdited).toLocaleDateString()}</p>
              </div>
            </div>
          </Card>
        ))}
