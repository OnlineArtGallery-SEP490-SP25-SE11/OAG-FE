...
export default function BlogList({bookmarkIds = [], isSignedIn} : {bookmarkIds: string[], isSignedIn: boolean}) {
    const { blogs, isError, isReachingEnd, size, setSize, isLoadingMore, isLoading } = useBlogs();
