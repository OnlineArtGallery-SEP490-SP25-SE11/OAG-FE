...
export function GalleryRoom() {
  ...
  const artworkPositions = calculateArtworkPositions(X_AXIS, 2, -Z_AXIS / 2 + 0.2);
  ...
  const rooms = useMemo(() => [
      ...
      walls: {
        back: (
          <Wall
            ...
            dimensions={{ width: X_AXIS, height: Y_AXIS, depth: 0.2 }}
            material={{
              color: "#f0f0f0",
        ...
        left: (
          <Wall
            ...
            dimensions={{ width: Z_AXIS, height: Y_AXIS, depth: 0.2 }}
            material={{
              color: "#f0f0f0",
              texture: defaultWallTexture,
              roughness: 1,
        ...
        right: (
          <DoorWall
            ...
            material={{ color: "#f0f0f0", texture: defaultWallTexture }}
          />
        ),
      },
      artworks: [
        { id: 1, url: ARTWORK_URL.ARTWORK_1, position: artworkPositions[0] },
        { id: 2, url: ARTWORK_URL.ARTWORK_2, position: artworkPositions[1] },
      ],
    ...
    // Second floor configuration
    {
      ...
      artworks: [
        { id: 3, url: ARTWORK_URL.ARTWORK_3, position: artworkPositions[0] },
        { id: 4, url: ARTWORK_URL.ARTWORK_4, position: artworkPositions[1] },
      ],

    },
  ], [X_AXIS, Y_AXIS, Z_AXIS, artworkPositions, defaultFloorTexture, defaultWallTexture]);
