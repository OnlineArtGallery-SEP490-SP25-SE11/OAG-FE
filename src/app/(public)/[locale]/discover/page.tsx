				...
				<div className='mb-12'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
						{galleries
							...
							.map((gallery) => (
								<Link
									href={`/exhibitions/${gallery.id}`}
									key={gallery.id}
								>
									<Card
										key={gallery.id}
										className='group overflow-hidden hover:shadow-lg hover:bg-gray-50 transition-transform duration-300'
									>
										<div className='relative aspect-[4/3]'>
											...
											<Badge className='absolute top-4 right-4 bg-gray-300'>
												Featured
											</Badge>
										</div>
										<div className='p-4'>
