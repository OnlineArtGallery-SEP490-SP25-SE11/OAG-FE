...
export function BlogPost({ blog, author, isBookmarked, userId, isHearted, heartCount }: BlogPostProps) {
  const readingTime = calculateReadingTime(blog.content);

  return (
    <article className="max-w-4xl mx-auto px-6">
      <BottomBar isBookmarked={isBookmarked} userId={userId} isHearted={isHearted} heartCount={heartCount} blogId={blog._id} />
