...
export function HeartCountDisplay({ blogId, initialHeartCount }: HeartCountDisplayProps) {
      ...
      <DialogContent>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {data.likedBy.map((user: { id: string; image: string; name: string; email: string }) => (
